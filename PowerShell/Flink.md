...
# Quickstart: Create a Flink Cluster with the PowerShell

This quickstart shows you how to use the PowerShell to deploy a Flink cluster in HDInsight on AKS Pool.
...
To create a Flink cluster, use the `New-AzHdInsightOnAksCluster` command:
```PowerShell
...
# Flink config
$flinkStorageUrl="abfs://flinksample@guodongwangstore.dfs.core.windows.net"
$taskManagerCpu=1
...
DatabaseUsername                            : 
DeploymentId                                : f313c63e0de840c99928282bf5b869b3
...
SystemDataCreatedAt                         : 6/2/2024 12:44:06 PM
SystemDataCreatedBy                         : guodongwang@microsoft.com
SystemDataCreatedByType                     : User
SystemDataLastModifiedAt                    : 6/2/2024 12:44:06 PM
...
WebFqdn                                     : FlinkSample.HDIClusterPoolSample.0b130652e15b417e885a050c9a3024a2.westus3.hdinsightaks.net
WebPrivateFqdn                              : 
WorkerDebugEnable                           : 
WorkerDebugPort                             : 
WorkerDebugSuspend                          : 
